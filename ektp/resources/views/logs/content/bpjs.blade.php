        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> History Tapping Smart BPJS
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-responsive-sm table-striped table-vertical-align">
                        ...
                        @foreach($models as $key => $model)
                            <tr>
								...
								<td>{{ $model->ruangan}}<br><span class="text-muted">Fitur : @if($model->mode == 'faskes1') Smart BPJS, Faskes Tingkat 1 @else Smart BPJS, Faskes Lanjutan @endif</span></td>
